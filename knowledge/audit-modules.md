...
**Структура:** **6 архетипов уборщиков** (M1-M6, реальные ревизии) + **8-мерная Florian-rubric** (финальная сборка score 0-100 в deep-режиме). Архетипы — это что Архитектор находит. Rubric — как складывается итоговая оценка по dimensions.
